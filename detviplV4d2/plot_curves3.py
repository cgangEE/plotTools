...
if __name__ == '__main__':
    ...
    curvesName.append('detviplV4d2-pvanet-ohem-D1-10.pkl')

    aliasCurvesName.append('detviplV4d2-pvanet-ohem-54ms')
    aliasCurvesName.append('detviplV4d2-pvanet-ohem-D1-54ms')
    aliasCurvesName.append('detviplV4d2-pvanet-ohem-D-54ms')
