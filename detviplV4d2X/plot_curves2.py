...
if __name__ == '__main__':
    ...
    curvesName.append('detviplV4d2X-pvanet-ohem-D-9.pkl')
    curvesName.append('detviplV4d2X-pvanet-ohem-D-1500x2000-9.pkl')
    curvesName.append('detviplV4d2XX-pvanet-ohem-D-1500x2000-2.pkl')

    aliasCurvesName.append('detviplV4d2X-pvanet-ohem-D-800x1440-64ms')
    aliasCurvesName.append('detviplV4d2X-pvanet-ohem-D-trainUpscale-1408x2016-127ms')
    aliasCurvesName.append('detviplV4d2XX-pvanet-ohem-D-trainUpscale-1504x2016-137ms')
