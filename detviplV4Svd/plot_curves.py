...
if __name__ == '__main__':
    curvesName = [ \
                    ...
                    'pvanet_full1_svd.pkl',\
                    'pvanet_full1_svd_1000x1500.pkl',\
                    'pvanet_full1_svd_1500x2000.pkl'
                    ]
    curves = []
    ...
    aliasCurvesName = [ 
                    'pvanet-ohem-trainUpscale_640x1000_54ms',\
                    'pvanet-ohem-trainUpscale_1000x1500_62ms',\
                    'pvanet-ohem-trainUpscale_1500x2000_98ms',\
                    'pvanet-ohem-trainUpscale_640x1000_SVD_34ms',\
                    'pvanet-ohem-trainUpscale_1000x1500_SVD_48ms',\
                    'pvanet-ohem-trainUpscale_1500x2000_SVD_82ms'\
                    ]
