...
if __name__ == '__main__':
    ...
    curvesName.append('detviplV4d2-pvanet-ohem-DHRoiAlignX-8.pkl')

    aliasCurvesName.append('detviplV4d2-pvanet-ohem-RoiPooling-54ms')
    aliasCurvesName.append('detviplV4d2-pvanet-ohem-D-RoiAlignX-54ms')
    aliasCurvesName.append('detviplV4d2-pvanet-ohem-DH-RoiAlignX')
