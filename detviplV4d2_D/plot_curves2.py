...
if __name__ == '__main__':
    ...
    curvesName.append('detviplV4d2-pvanet-ohem-D-9.pkl')
    curvesName.append('detviplV4d2-pvanet-ohem-DRoiAlign-10.pkl')
    curvesName.append('detviplV4d2-pvanet-ohem-DRoiAlignX-10.pkl')
    curvesName.append('detviplV4d2-pvanet-ohem-DRoiAlignX-Ge50-10.pkl')

    aliasCurvesName.append('detviplV4d2-pvanet-OHEM-D-RoiPooling')
    aliasCurvesName.append('detviplV4d2-pvanet-OHEM-D-RoiAlign')
    aliasCurvesName.append('detviplV4d2-pvanet-OHEM-D-RoiAlignX')
    aliasCurvesName.append('detviplV4d2-pvanet-OHEM-D-RoiAlignX-Ge50')
