...
def plot_roc(data, id, componentList):
    ...
    for i in xrange(num_part):
        ...
        plt.savefig('curves5' + componentList[i], 
...
if __name__ == '__main__':
    ...
    curvesName.append('psdbUpperBody-OhemC-pvanet-DRoiAlignX-10.pkl')
    ...
    aliasCurvesName.append('pvanet-ohemC-D-RoiAlign-X-roiHalf')
