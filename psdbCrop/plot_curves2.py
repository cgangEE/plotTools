...
if __name__ == '__main__':
    ...
    aliasCurvesName.append('psdbCrop-psdbFourParts-NonMul-fppi0.1')
    aliasCurvesName.append('psdbCrop-psdbFourParts-Mul-fppi0.1')
    aliasCurvesName.append('psdbCrop-psdbFourParts-NonMul-fppi1')
    aliasCurvesName.append('psdbCrop-psdbFourParts-Mul-fppi1')
