...
if __name__ == '__main__':
    ...
    curvesName.append('detviplV5d0-pvanet-ohem-DRoiAlignX-10.pkl')
    curvesName.append('detviplV7d0-pvanet-ohem-DRoiAlignX-10.pkl')

    componentList = ['pedestrain', 'vehicle', 'riding_tool', 'riding_whole']
    
    aliasCurvesName.append('detviplV7.0')
    aliasCurvesName.append('detviplV7.0.1')
