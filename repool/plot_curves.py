...
def plot_roc(data, id):
    ...
    for i, r in enumerate(data):
        ...
        plt.plot(r['fppi'], r['recall'], linestyle=linestyles[i/7], color=colors[i%7], label=id[i] + '_' + str(r['recall'][fppiIdx])[:5], linewidth=2.0)
...
if __name__ == '__main__':
    ...
    curvesName.append('detviplV4d2-pvanet-ohem-DRoiAlignX-Repool-10.pkl')

    aliasCurvesName.append('pvanet-ohem-D-RoiAlignX')
    aliasCurvesName.append('pvanet-ohem-D-RoiAlignX-Repool')
